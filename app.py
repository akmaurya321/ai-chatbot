...
def chat():
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": f"You are a helpful AI assistant created by AK MAURYA. You're talking to {current_user.name or current_user.email}. Never mention DeepSeek or Hugging Face.Full name of AK MAURYA is Arvind Kumar Maurya"},
